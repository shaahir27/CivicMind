...
export type ErrorCode = 'VALIDATION_ERROR' | 'UNAUTHENTICATED' | 'FORBIDDEN_SCOPE' | 'NOT_FOUND' | 'INVALID_STATE_TRANSITION' | 'DUPLICATE_IDEMPOTENCY_KEY' | 'MISSING_REQUIRED_EVIDENCE' | 'OUTSIDE_SERVICE_AREA' | 'INSUFFICIENT_DATA' | 'RATE_LIMITED' | 'INTERNAL_ERROR';
