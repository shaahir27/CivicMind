...
1. **Open the Citizen App** and log in as **`jane.citizen@example.com`** with password **`password123`**.
...
1. **Open the Authority App** and log in as `officer.bescom@civicmind.gov` with password **`password123`** (your seeded demo account with global bypass privileges).
...
## Part 4: The Admin Experience (AI Oversight)

**Goal:** Demonstrate the system-wide AI features and impact tracking.

1. **Open the Admin Console** and log in as `admin@civicmind.gov` with password **`password123`**.
2. **Impact Reports:**
   - Navigate to Impact Reports and click "Generate Report".
   - Show how the system aggregates resolved issues to calculate a Civic Health Score and estimated cost savings.
3. **Predictive Analytics:**
   - Navigate to Predictive Review and click "Run Prediction Cycle".
   - Explain how the Predictor Agent analyzes historical data (e.g., repeating potholes in Indiranagar) to forecast future hotspots before they are even reported.
